...
StyleRule downCompact(List<StyleRule> rules) =>
    css.media(MediaQuery.all(maxWidth: docsCompactBreakpoint.px), rules);

StyleRule downMobile(List<StyleRule> rules) =>
    css.media(MediaQuery.all(maxWidth: docsMobileBreakpoint.px), rules);

StyleRule downContent(List<StyleRule> rules) =>
    css.media(MediaQuery.all(maxWidth: docsContentBreakpoint.px), rules);

StyleRule downWide(List<StyleRule> rules) =>
    css.media(MediaQuery.all(maxWidth: docsWideBreakpoint.px), rules);
