...
class JasprDocProcessor {
  ...
  JasprDocProcessor(this.packageGraph, this.paths,
  ...
  /// Strips dangerous HTML constructs from rendered documentation and
  /// applies VitePress-specific escaping (Vue template syntax).
  ...
  static String sanitizeHtml(String html,
    ...
    // Jaspr does not need Vue template escaping.
    return core_sanitize.sanitizeHtml(html,
  ...
  /// [JasprPathResolver]. For external elements (SDK, pub packages),
...
class MarkdownRenderer implements md.NodeVisitor {
  ...
  /// Link text is already escaped by [JasprDocProcessor._escapeLinkText],
