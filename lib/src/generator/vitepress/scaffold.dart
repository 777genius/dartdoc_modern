...
class VitePressInitGenerator {
  ...
  Future<void> generate({
    ...
    // + vitepress build before dartdoc_modern).
    // Written directly to disk (not through writer) because the full
    // generation will overwrite these files via _writeMarkdown, and the
    ...
    _writeFileToDisk(
      outputFile: '.vitepress/generated/api-styles.css',
      content: '/* Generated by dartdoc_modern — will be overwritten */\n',
    );
