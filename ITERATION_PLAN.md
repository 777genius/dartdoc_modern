# dartdoc_modern — Iteration 1 (MVP)
...
```typescript
// AUTO-GENERATED by dartdoc_modern -- do not edit manually.
...
**Verify:** `dartdoc_modern --format vitepress --output docs/` produces empty-stub .md files.
...
9. **`lib/src/generator/vitepress_init.dart`** (~100 lines)
   - `dartdoc_modern --format vitepress --output docs/ --init` creates:
...
dartdoc_modern --format vitepress --output docs/

# Initialize VitePress project scaffold (first time, no generation)
dartdoc_modern --format vitepress --output docs/ --init
...
1. `dartdoc_modern --format vitepress --output docs/` generates valid VitePress site
